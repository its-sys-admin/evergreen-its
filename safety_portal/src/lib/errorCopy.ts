...
export const ERROR_COPY: Record<string, string> = {
  ...
  wrong_state: "That doesn't fit the record — reload to see where this document currently stands.",
  invalid_action: "That action isn't available for this document type.",
  invalid_doc_type: "That document type isn't recognized.",
