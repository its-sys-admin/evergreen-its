 ...
 * job's eight containers (four Smartsheet folders, four Box) on its next cycle and reports back,
      ...
      {state === "none" && (
        <>
          <p className="dash-card__sub muted">
            Moves this job&apos;s eight folders into the ITS — Archive area. Reversible.
          </p>
