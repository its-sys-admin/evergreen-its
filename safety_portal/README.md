...
> It is a DOCUMENTATION gap, not an apply hazard — the command below is `migrations apply`, which
> applies everything pending in order regardless of what this table says. Worth a reconciling pass.
