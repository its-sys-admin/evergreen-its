...
| `0062_gayk_weekly_maintenance_checklist` | GAYK/DOYLE pile-driver **weekly maintenance** inspection-library seed — one `generic_inspection` template, 9 duties. CONTENT-ONLY, same shape as `0061`. Seeds NO recurrence row: cadence is a per-job/per-person operator assignment | (#47) | ☐ pending |
